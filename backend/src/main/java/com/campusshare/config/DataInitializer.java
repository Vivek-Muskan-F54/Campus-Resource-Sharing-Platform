...
public class DataInitializer {
 @Bean CommandLineRunner seed(UserRepository users,CategoryRepository categories,PasswordEncoder encoder,@Value("${app.admin.email:admin@campus.edu}")String email,@Value("${app.admin.password:ChangeMe123!}")String password){return args->{
